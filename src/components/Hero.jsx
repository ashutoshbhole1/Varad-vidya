...
export default function Hero() {
  return (
    <section className="relative   bg-gradient-to-b from-blue-50 via-white to-white overflow-hidden pt-20 pb-32  ">
      {/* Background Elements */}
      ...
      <div className="relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              <h1 className="text-5xl md:text-6xl font-bold leading-tight text-foreground animate-fade-in-up" style={{ animationDelay: '0.1s' }}>
                Your Digital Portal to <span className="bg-gradient-to-r from-primary via-primary-light to-secondary bg-clip-text text-transparent">Excellence</span>
              </h1>
            ...
            <div className="flex flex-col sm:flex-row gap-4 pt-4 animate-fade-in-up" style={{ animationDelay: '0.3s' }}>
              <button className="group px-8 py-4 bg-gradient-primary text-white rounded-lg font-semibold flex items-center gap-2 hover:shadow-xl transition-smooth hover:-translate-y-1">
                Get Started Free
          ...
          <div className="relative h-full min-h-[500] flex items-center justify-center">
