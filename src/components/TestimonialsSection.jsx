...
export default () => {
    ...
    const testimonials = [
        {
            avatar: "/Testimonials/Vinay Gupta.jpg",
            name: "Vinay Gupta",
            title: "Student - Skill Development Program",
            quote: "I started as a beginner and now feel confident applying what I learned. The guidance and structure made learning smooth and effective."
        },
        {
            avatar: "/Testimonials/Sanu Yadav.jpg",
            name: "Sanu Yadav",
            title: "Student - Skill Development Program",
            quote: "The course was easy to follow and very practical. It helped me build real skills with confidence, not just theoretical knowledge."
        },
        {
            avatar: "/Testimonials/Kritika Stokes.jpg",
            name: "Kritika Stokes",
            title: "Founder - Kilox",
            quote: "Working with the team was a smooth experience. They understood our requirements clearly and delivered a professional, results-driven website on time."
        },
    ]
        ...
        <section className="relative py-14">
            <div className="relative z-10 max-w-screen-xl mx-auto px-4 md:px-8">
                <div className="max-w-xl sm:text-center md:mx-auto">
                    ...
                    <h2 className="text-4xl md:text-5xl font-bold text-foreground text-center mb-6 animate-fade-in-up">
                        Testimonials
                    </h2>

                    <p className="mt-3 text-gray-600">
                        Real stories of students building their future and businesses trusting us for reliable, results-driven digital solutions.
                    </p>
                </div>
                ...
                <div className="mt-12">
                    ...
                    <ul className="grid items-top gap-6 sm:grid-cols-2 lg:grid-cols-3">
                        {
                            testimonials.map((item, idx) => (
                                <li key={idx} className="bg-white rounded-xl max-h-max h-fit overflow-hidden border border-blue-200 shadow-md">
                                    ...
                                    <figure className="flex h-full flex-col">
                                        ...
                                        <div className="flex items-center gap-x-4 p-4 mt-6 bg-blue-50">
                                            <img src={item.avatar} className="w-16 h-16 rounded-full border-2 border-blue-500" />
                                            <div>
